...
public class BotService {
    ...
    public Mono<Void> disconnectBot(final String conferenceId, final String eventId,
        ...
        public CreateBotResponse createBot(CreateBotRequest request) {
                ...
                // final CreateBotTask createBotTask = botTaskProducer.createBotTask(botId,
                // meetingUrl);
                // botTaskProducer.sendCreateBotTask(createBotTask); или
                // kafkaRepository.sendCreateBotTask(createBotTask);

                // Связь clientId ↔ botId в SessionService (будет установлена при WS
                // подключении)
