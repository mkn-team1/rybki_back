...
import com.rybki.spring_boot.llm.gigachat.dto.GigaChatTokenDto;
...
/**
 * Реализация аутентификации для GigaChat.
...
public class GigaChatAuthProvider implements LlmAuthProvider {
    ...
    public Mono<String> getAccessToken() {
        final String currentToken = accessToken.get();
        final Long expiresAt = tokenExpiresAt.get();
