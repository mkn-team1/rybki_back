...
public record GigaChatRequestDto(
    ...
    public static Message getAssistantMessage(final String text) {
        log.debug("🤖 [DTO_FACTORY] Creating assistant message with text length: {}",
    ...
    public static Message getPreviousIdeasMessage(final Queue<List<String>> previousIdeas) {
        ...
        if (previousIdeas == null || previousIdeas.isEmpty()) {
            log.debug("📭 [DTO_FACTORY] No previous ideas found");
            ...
            log.debug("📖 [DTO_FACTORY] Including {} previous ideas in context", totalIdeas);
        ...
        log.debug("📝 [DTO_FACTORY] Previous ideas message length: {}",
